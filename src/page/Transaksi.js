...
export default class Home extends React.Component{
    ...
    saveTransaksi = event => {
        ...
        form.append("bulan_bayar", this.state.bulan_bayar)
        form.append("tahun_bayar", this.state.tahun_bayar)
            ...
            <div>
                ...
                <div className="col-sm-8 card my-5">
                    ...
                    <h6 className="text-dark">
                                     ...
                                     value={this.state.bulan_bayar}
                                     onChange={ev => this.setState({bulan_bayar: ev.target.value})}
                                     required/></h6>
